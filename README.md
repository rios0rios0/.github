...
The workflow reads from a `COMPLIANCE_AUDIT_TOKEN` repository secret. Create a fine-grained Personal Access Token with `repo` + `admin:repo_hook` scopes and store it:
